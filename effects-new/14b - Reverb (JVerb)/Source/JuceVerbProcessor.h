...
class JuceVerbProcessor : public AudioProcessor
...
public:
    ...
    const String getName() const override { return "JuceVerb"; }
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (JuceVerbProcessor)
};