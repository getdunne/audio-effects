...
public:
    ...
    TremoloParameters parameters;

private:
    float lfoPhase;             // Phase of the low-frequency oscillator, range 0 to 1
    double inverseSampleRate;   // It's more efficient to multiply than divide, so
