...
class {{ projectName }}Processor : public AudioProcessor
{
public:
    ...
    const String getName() const override { return "{{ projectName }}"; }
...
public:
    ...
    {{ projectName }}Parameters parameters;

private:
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR ({{ projectName }}Processor)
};
